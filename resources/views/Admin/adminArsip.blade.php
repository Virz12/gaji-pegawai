...
<head>
    ...
    <script>
        const search = "{{ route('Admin.adminarsip',['datapegawai' => $datapegawai]) }}";
...
<body class="min-vh-100 bg-body-secondary">
    ...
    <main class="container-fluid ps-3 my-4">
        <section class="row g-2 justify-content-between">
            <a href="/admindaftarpegawai" class="btn btn-success mb-sm-3 ms-1 col-auto"><i class="fa-solid fa-arrow-left me-2"></i>Kembali</a>
