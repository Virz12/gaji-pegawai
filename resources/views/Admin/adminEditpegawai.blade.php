...
<body class="min-vh-100 bg-body-secondary">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <ul class="nav nav-underline ms-auto mb-2 mb-lg-0 me-auto flex-column flex-lg-row">
                    <li class="nav-item">
                        <a class="nav-link text-black d-inline-block" aria-current="page" href="/admindashboard"><i class="fa-solid fa-comment"></i> Kirim Pesan</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="d-flex align-items-sm-center justify-content-center mt-3 mb-3 mb-sm-0 mt-sm-0 h-card-edit">
        <div class="card p-3 w-100 mx-3 w-md-50 w-xxl-25">
            ...
            <form action="{{ route('Admin.updatepegawai', ['datapegawai' => $datapegawai]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
