...
<head>
    ...
    <script>
        const search = "{{ route('Admin.admindaftarpegawai') }}";
    </script>
...
<body class="min-vh-100 bg-body-secondary">
    ...
    <main class="container-fluid ps-3 my-4">
        <section class="row g-2 justify-content-between">
            <a href="/admintambahpegawai" class="btn btn-success mb-sm-3 ms-1 col-auto"><i class="fa-solid fa-plus me-2"></i>Tambah Pegawai</a>
                        ...
                        <ul class="list-group list-group-flush">                
                            ...
                            <li class="list-group-item ">
                                <div class="d-flex justify-content-between ">
                                    <a href="{{route('Admin.admineditpegawai',['datapegawai' => $pegawai])}}" class="btn btn-primary w-50 me-1"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                                ...
                                <a href="{{route('Admin.adminarsip',['datapegawai' => $pegawai])}}" class="btn btn-warning w-100 mt-2"><i class="fa-solid fa-message"></i> Arsip Pesan</a>
                            </li>                                                
                        </ul>
                    </div>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="/adminhapuspegawai/{{ $pegawai->id }}">
                            <form action="{{route('Admin.delete',['datapegawai' => $pegawai])}}">
                                @csrf
                                @method('DELETE')
