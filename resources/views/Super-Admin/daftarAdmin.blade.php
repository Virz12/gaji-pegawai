...
<head>
    ...
    <script>
        const search = "{{ route('Super-Admin.daftaradmin') }}";
    </script>
                    ...
                    <div class="overflow-hidden rounded">
                        <ul class="list-group list-group-flush">                
                            <div class="d-flex justify-content-end pt-2 pe-2">
                                <a  href="{{ route('Super-Admin.editadmin',['user' => $admin]) }}" class="btn btn-warning w-15 " ><i class="fa-solid fa-pencil text-white"></i></a>
                            ...
                            <li class="list-group-item">
                                ...
                                @if ( $admin->status == 'Aktif' )                                
                                    <button type="submit" class="btn fw-normal  rounded-pill btn-success fs-6 w-50 me-1" >Aktif</button>
                                @else
                                <a href="/aktif/{{ $admin->id }}" class="text-decoration-none  w-50">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{route('Super-Admin.deleteadmin',['dataadmin' => $admin])}}">
                                @csrf
                                @method('DELETE')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('Super-Admin.tambahadmin') }}" method="POST">
                            @csrf
                            @method('POST')
