...
<head>
    ...
    <script>
        const search = "{{ route('Super-Admin.dashboard') }}";
        const dataPegawai = "{{ route('Super-Admin.datapegawai') }}";
    </script>
    ...
    <main class="row mx-2 mb-4 justify-content-center">
        ...
        <section class="col-md-8 col-xxl-8 mt-4 mt-md-3">
            <div class="card p-3">
                ...
                <form id="whatsappForm" action="{{route('Super-Admin.whatsapp')}}" method="POST" enctype="multipart/form-data" data-save-template-url="{{ route('Super-Admin.simpanTemplate') }}">
                    @csrf
                    @method('POST')
